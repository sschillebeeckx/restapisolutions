...
public class PersonRepositoryTest {
	...
	@Test
	@Order(4)
	public void addNewPerson() throws IOException, PersonAlreadyExistsException {
	...
	public void addExistingPersonThrowsException()  {
		Address a = new Address("Diestsevest",32,"3000","Leuven");
		Company c = new Company("Abis","016/455610","BE12345678",a);
		Person p = new Person(6,"Sam","Schillebeeckx", LocalDate.of(1995,03,19),"sschillebeeckx@abis.be","abis123","nl",c);
	...
	@Test
	@Order(8)
	public void deleteNonExistingPersonThrowsException()  {
		assertThrows(PersonCanNotBeDeletedException.class,()->personRepository.deletePerson(4));
	}
